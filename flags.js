const flags = {
    ...
    type_flags: [
        ...
        { bit: 8, name: "CREATURE_TYPE_FLAG_DO_NOT_PLAY_WOUND_ANIM" },
        ...
        { bit: 4194304, name: "CREATURE_TYPE_FLAG_LINK_ALL" },
        ...
        { bit: 2147483648, name: "CREATURE_TYPE_FLAG_QUEST_BOSS" }
    ],
    ...
    flags_extra: [
        ...
        { bit: 8192, name: "CREATURE_FLAG_EXTRA_CANNOT_ENTER_COMBAT" },
        ...
        { bit: 134217728, name: "CREATURE_FLAG_EXTRA_DONT_OVERRIDE_ENTRY_SAI" },
    ...
    spellattr4: [
        ...
        { bit: 16384, name: "SPELL_ATTR4_DAMAGE_DOESNT_BREAK_AURAS" },
    ...
    specialflags: [
        { bit: 1, name: "QUEST_SPECIAL_FLAGS_REPEATABLE" },
        { bit: 2, name: "QUEST_SPECIAL_FLAGS_EXPLORATION_OR_EVENT" },
        { bit: 4, name: "QUEST_SPECIAL_FLAGS_AUTO_ACCEPT" },
        { bit: 8, name: "QUEST_SPECIAL_FLAGS_DF_QUEST" },
        { bit: 16, name: "QUEST_SPECIAL_FLAGS_MONTHLY" },
        { bit: 32, name: "QUEST_SPECIAL_FLAGS_CAST" },
        { bit: 64, name: "QUEST_SPECIAL_FLAGS_NO_REP_SPILLOVER" },
        { bit: 128, name: "QUEST_SPECIAL_FLAGS_CAN_FAIL_IN_ANY_STATE" },
        { bit: 256, name: "QUEST_SPECIAL_FLAGS_NO_LOREMASTER_COUNT" }        
    ],
    itemflags: [
        { bit: 1, name: "ITEM_FLAG_NO_PICKUP" },
        { bit: 2, name: "ITEM_FLAG_CONJURED" },
        { bit: 4, name: "ITEM_FLAG_HAS_LOOT" },
        { bit: 8, name: "ITEM_FLAG_HEROIC_TOOLTIP" },
        { bit: 16, name: "ITEM_FLAG_DEPRECATED" },
        { bit: 32, name: "ITEM_FLAG_NO_USER_DESTROY" },
        { bit: 64, name: "ITEM_FLAG_PLAYERCAST" },
        { bit: 128, name: "ITEM_FLAG_NO_EQUIP_COOLDOWN" },
        { bit: 256, name: "ITEM_FLAG_MULTI_LOOT_QUEST" },
        { bit: 512, name: "ITEM_FLAG_IS_WRAPPER" },
        { bit: 1024, name: "ITEM_FLAG_USES_RESOURCES" },
        { bit: 2048, name: "ITEM_FLAG_MULTI_DROP" },
        { bit: 4096, name: "ITEM_FLAG_ITEM_PURCHASE_RECORD" },
        { bit: 8192, name: "ITEM_FLAG_PETITION" },
        ...
        { bit: 262144, name: "ITEM_FLAG_IS_PROSPECTABLE" },
        { bit: 524288, name: "ITEM_FLAG_UNIQUE_EQUIPPABLE" },
        { bit: 1048576, name: "ITEM_FLAG_IGNORE_FOR_AURAS" },
        { bit: 2097152, name: "ITEM_FLAG_IGNORE_DEFAULT_ARENA_RESTRICTIONS" },
        { bit: 4194304, name: "ITEM_FLAG_NO_DURABILITY_LOSS" },
        { bit: 8388608, name: "ITEM_FLAG_USE_WHEN_SHAPESHIFTED" },
        { bit: 16777216, name: "ITEM_FLAG_HAS_QUEST_GLOW" },
        { bit: 33554432, name: "ITEM_FLAG_HIDE_UNUSABLE_RECIPE" },
        { bit: 67108864, name: "ITEM_FLAG_NOT_USEABLE_IN_ARENA" },
        { bit: 134217728, name: "ITEM_FLAG_IS_BOUND_TO_ACCOUNT" },
        { bit: 268435456, name: "ITEM_FLAG_NO_REAGENT_COST" },
        { bit: 536870912, name: "ITEM_FLAG_IS_MILLABLE" },
    ...
    InterruptFlags: [
        { bit: 1, name: "SPELL_INTERRUPT_FLAG_MOVEMENT" },
        { bit: 2, name: "SPELL_INTERRUPT_FLAG_PUSH_BACK" },
        { bit: 4, name: "SPELL_INTERRUPT_FLAG_UNK3" },
        { bit: 8, name: "SPELL_INTERRUPT_FLAG_INTERRUPT" },
        { bit: 16, name: "SPELL_INTERRUPT_FLAG_ABORT_ON_DMG" },
        { bit: 32, name: "SPELL_INTERRUPT_UNK" }
    ],
    AuraInterruptFlags: [
        { bit: 1, name: "AURA_INTERRUPT_FLAG_HITBYSPELL" },
        { bit: 2, name: "AURA_INTERRUPT_FLAG_TAKE_DAMAGE" },
        { bit: 4, name: "AURA_INTERRUPT_FLAG_CAST" },
        { bit: 8, name: "AURA_INTERRUPT_FLAG_MOVE" },
        { bit: 16, name: "AURA_INTERRUPT_FLAG_TURNING" },
        { bit: 32, name: "AURA_INTERRUPT_FLAG_JUMP" },
        { bit: 64, name: "AURA_INTERRUPT_FLAG_NOT_MOUNTED" },
        { bit: 128, name: "AURA_INTERRUPT_FLAG_NOT_ABOVEWATER" },
        { bit: 256, name: "AURA_INTERRUPT_FLAG_NOT_UNDERWATER" },
        { bit: 512, name: "AURA_INTERRUPT_FLAG_NOT_SHEATHED" },
        { bit: 1024, name: "AURA_INTERRUPT_FLAG_TALK" },
        { bit: 2048, name: "AURA_INTERRUPT_FLAG_USE" },
        { bit: 4096, name: "AURA_INTERRUPT_FLAG_MELEE_ATTACK" },
        { bit: 8192, name: "AURA_INTERRUPT_FLAG_SPELL_ATTACK" },
        { bit: 16384, name: "AURA_INTERRUPT_FLAG_UNK14" },
        { bit: 32768, name: "AURA_INTERRUPT_FLAG_TRANSFORM" },
        { bit: 65536, name: "AURA_INTERRUPT_FLAG_UNK16" },
        { bit: 131072, name: "AURA_INTERRUPT_FLAG_MOUNT" },
        { bit: 262144, name: "AURA_INTERRUPT_FLAG_NOT_SEATED" },
        { bit: 524288, name: "AURA_INTERRUPT_FLAG_CHANGE_MAP" },
        { bit: 1048576, name: "AURA_INTERRUPT_FLAG_IMMUNE_OR_LOST_SELECTION" },
        { bit: 2097152, name: "AURA_INTERRUPT_FLAG_UNK21" },
        { bit: 4194304, name: "AURA_INTERRUPT_FLAG_TELEPORTED" },
        { bit: 8388608, name: "AURA_INTERRUPT_FLAG_ENTER_PVP_COMBAT" },
        { bit: 16777216, name: "AURA_INTERRUPT_FLAG_DIRECT_DAMAGE" },
        { bit: 33554432, name: "AURA_INTERRUPT_FLAG_LANDING" },
        { bit: 2147483648, name: "AURA_INTERRUPT_FLAG_LEAVE_COMBAT" }
    ],
    ChannelInterruptFlags: [
        { bit: 8, name: "CHANNEL_INTERRUPT_FLAG_INTERRUPT" },
        { bit: 16384, name: "CHANNEL_FLAG_DELAY" }
    ],
    Targets: [
        { bit: 1, name: "TARGET_FLAG_UNUSED_1" },
        { bit: 2, name: "TARGET_FLAG_UNIT" },
        { bit: 4, name: "TARGET_FLAG_UNIT_RAID" },
        { bit: 8, name: "TARGET_FLAG_UNIT_PARTY" },
        { bit: 16, name: "TARGET_FLAG_ITEM" },
        { bit: 32, name: "TARGET_FLAG_SOURCE_LOCATION" },
        { bit: 64, name: "TARGET_FLAG_DEST_LOCATION" },
        { bit: 128, name: "TARGET_FLAG_UNIT_ENEMY" },
        { bit: 256, name: "TARGET_FLAG_UNIT_ALLY" },
        { bit: 512, name: "TARGET_FLAG_CORPSE_ENEMY" },
        { bit: 1024, name: "TARGET_FLAG_UNIT_DEAD" },
        { bit: 2048, name: "TARGET_FLAG_GAMEOBJECT" },
        { bit: 4096, name: "TARGET_FLAG_TRADE_ITEM" },
        { bit: 8192, name: "TARGET_FLAG_STRING" },
        { bit: 16384, name: "TARGET_FLAG_GAMEOBJECT_ITEM" },
        { bit: 32768, name: "TARGET_FLAG_CORPSE_ALLY" },
        { bit: 65536, name: "TARGET_FLAG_UNIT_MINIPET" },
        { bit: 131072, name: "TARGET_FLAG_GLYPH_SLOT" },
        { bit: 262144, name: "TARGET_FLAG_DEST_TARGET" },
        { bit: 524288, name: "TARGET_FLAG_UNUSED20" },
        { bit: 1048576, name: "TARGET_FLAG_UNIT_PASSENGER" }
    ],
    FacingCasterFlags: [
        { bit: 1, name: "SPELL_FACING_FLAG_INFRONT" }
    ],
    ShapeshiftMask: [
        { bit: 1, name: "FORM_CAT" },
        { bit: 2, name: "FORM_TREE" },
        { bit: 4, name: "FORM_TRAVEL" },
        { bit: 8, name: "FORM_AQUA" },
        { bit: 16, name: "FORM_BEAR" },
        { bit: 32, name: "FORM_AMBIENT" },
        { bit: 64, name: "FORM_GHOUL" },
        { bit: 128, name: "FORM_DIREBEAR" },
        { bit: 256, name: "FORM_STEVES_GHOUL" },
        { bit: 512, name: "FORM_THARONJA_SKELETON" },
        { bit: 1024, name: "FORM_TEST_OF_STRENGTH" },
        { bit: 2048, name: "FORM_BLB_PLAYER" },
        { bit: 4096, name: "FORM_SHADOW_DANCE" },
        { bit: 8192, name: "FORM_CREATUREBEAR" },
        { bit: 16384, name: "FORM_CREATURECAT" },
        { bit: 32768, name: "FORM_GHOSTWOLF" },
        { bit: 65536, name: "FORM_BATTLESTANCE" },
        { bit: 131072, name: "FORM_DEFENSIVESTANCE" },
        { bit: 262144, name: "FORM_BERSERKERSTANCE" },
        { bit: 524288, name: "FORM_TEST" },
        { bit: 1048576, name: "FORM_ZOMBIE" },
        { bit: 2097152, name: "FORM_METAMORPHOSIS" },
        { bit: 16777216, name: "FORM_UNDEAD" },
        { bit: 33554432, name: "FORM_MASTER_ANGLER" },
        { bit: 67108864, name: "FORM_FLIGHT_EPIC" },
        { bit: 134217728, name: "FORM_SHADOW" },
        { bit: 268435456, name: "FORM_FLIGHT" },
        { bit: 536870912, name: "FORM_STEALTH" },
        { bit: 1073741824, name: "FORM_MOONKIN" },
        { bit: 2147483648, name: "FORM_SPIRITOFREDEMPTION" }
    ],
    TargetCreatureType: [
        { bit: 1, name: "CREATURE_TYPE_BEAST" },
        { bit: 2, name: "CREATURE_TYPE_DRAGONKIN" },
        { bit: 4, name: "CREATURE_TYPE_DEMON" },
        { bit: 8, name: "CREATURE_TYPE_ELEMENTAL" },
        { bit: 16, name: "CREATURE_TYPE_GIANT" },
        { bit: 32, name: "CREATURE_TYPE_UNDEAD" },
        { bit: 64, name: "CREATURE_TYPE_HUMANOID" },
        { bit: 128, name: "CREATURE_TYPE_CRITTER" },
        { bit: 256, name: "CREATURE_TYPE_MECHANICAL" },
        { bit: 512, name: "CREATURE_TYPE_NOT_SPECIFIED" },
        { bit: 1024, name: "CREATURE_TYPE_TOTEM" },
    ...
    ItemFieldFlags: [
        { bit: 1, name: "ITEM_FIELD_FLAG_SOULBOUND" },
        { bit: 2, name: "ITEM_FIELD_FLAG_UNK1" },
        { bit: 4, name: "ITEM_FIELD_FLAG_UNLOCKED" },
        { bit: 8, name: "ITEM_FIELD_FLAG_WRAPPED" },
        { bit: 16, name: "ITEM_FIELD_FLAG_UNK2" },
        { bit: 32, name: "ITEM_FIELD_FLAG_UNK3" },
        { bit: 64, name: "ITEM_FIELD_FLAG_UNK4" },
        { bit: 128, name: "ITEM_FIELD_FLAG_UNK5" },
        { bit: 256, name: "ITEM_FIELD_FLAG_BOP_TRADEABLE" },
        { bit: 512, name: "ITEM_FIELD_FLAG_READABLE" },
        { bit: 1024, name: "ITEM_FIELD_FLAG_UNK6" },
        { bit: 2048, name: "ITEM_FIELD_FLAG_UNK7" },
        { bit: 4096, name: "ITEM_FIELD_FLAG_REFUNDABLE" },
        { bit: 8192, name: "ITEM_FIELD_FLAG_UNK8" },
        { bit: 16384, name: "ITEM_FIELD_FLAG_UNK9" },
        { bit: 32768, name: "ITEM_FIELD_FLAG_UNK10" },
        { bit: 65536, name: "ITEM_FIELD_FLAG_UNK11" },
        { bit: 131072, name: "ITEM_FIELD_FLAG_UNK12" },
        { bit: 262144, name: "ITEM_FIELD_FLAG_UNK13" },
        { bit: 524288, name: "ITEM_FIELD_FLAG_UNK14" },
        { bit: 1048576, name: "ITEM_FIELD_FLAG_UNK15" },
        { bit: 2097152, name: "ITEM_FIELD_FLAG_UNK16" },
        { bit: 4194304, name: "ITEM_FIELD_FLAG_UNK17" },
        { bit: 8388608, name: "ITEM_FIELD_FLAG_UNK18" },
        { bit: 16777216, name: "ITEM_FIELD_FLAG_UNK19" },
        { bit: 33554432, name: "ITEM_FIELD_FLAG_UNK20" },
        { bit: 67108864, name: "ITEM_FIELD_FLAG_UNK21" },
        { bit: 134217728, name: "ITEM_FIELD_FLAG_UNK22" },
        { bit: 268435456, name: "ITEM_FIELD_FLAG_UNK23" },
        { bit: 536870912, name: "ITEM_FIELD_FLAG_UNK24" },
        { bit: 1073741824, name: "ITEM_FIELD_FLAG_UNK25" },
        { bit: 2147483648, name: "ITEM_FIELD_FLAG_UNK26" }
    ],
    socketColor: [
        { bit: 1, name: "SOCKET_COLOR_META" },
        { bit: 2, name: "SOCKET_COLOR_RED" },
